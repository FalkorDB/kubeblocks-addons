...
Describe "FalkorDB Cluster Common Bash Script Tests"
  ...
  Describe "get_all_shards_pods()"
    setup() {
      export ALL_SHARDS_POD_NAME_LIST_SHARD_98X="falkordb-shard-98x-0,falkordb-shard-98x-1"
      export ALL_SHARDS_POD_NAME_LIST_SHARD_CQ7="falkordb-shard-cq7-0,falkordb-shard-cq7-1"
      export ALL_SHARDS_POD_NAME_LIST_SHARD_HY7="falkordb-shard-hy7-0,falkordb-shard-hy7-1"
    }
    Before "setup"
    ...
    It "returns all shard pods"
      ...
      The status should be success
      The output should eq "falkordb-shard-98x-0,falkordb-shard-98x-1,falkordb-shard-cq7-0,falkordb-shard-cq7-1,falkordb-shard-hy7-0,falkordb-shard-hy7-1"
    End
  End

  Describe "get_all_shards_pod_fqdns()"
    setup() {
      export ALL_SHARDS_POD_FQDN_LIST_SHARD_98X="falkordb-shard-98x-0.falkordb-shard-98x-headless.default.cluster.local,falkordb-shard-98x-1.falkordb-shard-98x-headless.default.cluster.local"
      export ALL_SHARDS_POD_FQDN_LIST_SHARD_CQ7="falkordb-shard-cq7-0.falkordb-shard-cq7-headless.default.cluster.local,falkordb-shard-cq7-1.falkordb-shard-cq7-headless.default.cluster.local"
      export ALL_SHARDS_POD_FQDN_LIST_SHARD_HY7="falkordb-shard-hy7-0.falkordb-shard-hy7-headless.default.cluster.local,falkordb-shard-hy7-1.falkordb-shard-hy7-headless.default.cluster.local"
    }
    Before "setup"
    ...
    It "returns all shard pod FQDNs"
      ...
      The status should be success
      The output should eq "falkordb-shard-98x-0.falkordb-shard-98x-headless.default.cluster.local,falkordb-shard-98x-1.falkordb-shard-98x-headless.default.cluster.local,falkordb-shard-cq7-0.falkordb-shard-cq7-headless.default.cluster.local,falkordb-shard-cq7-1.falkordb-shard-cq7-headless.default.cluster.local,falkordb-shard-hy7-0.falkordb-shard-hy7-headless.default.cluster.local,falkordb-shard-hy7-1.falkordb-shard-hy7-headless.default.cluster.local"
    End
  End

  Describe "parse_advertised_svc_and_port()"
    It "parses advertised port from pod name and advertised ports"
      When call parse_advertised_svc_and_port "falkordb-shard-98x-0" "falkordb-shard-98x-advertised-0:6379,falkordb-shard-98x-advertised-1:6380"
      The status should be success
      The output should eq "6379"
    End

    It "returns 1 when advertised port not found"
      When call parse_advertised_svc_and_port "falkordb-shard-98x-2" "falkordb-shard-98x-advertised-0:6379,falkordb-shard-98x-advertised-1:6380"
      The status should be failure
    End
  End
  ...
  Describe "build_redis_cluster_create_command()"
    Context "when REDIS_DEFAULT_PASSWORD is not set"
      It "builds FalkorDB cluster create command without password"
    ...
    Context "when REDIS_DEFAULT_PASSWORD is set"
      ...
      It "builds FalkorDB cluster create command with password"
        primary_nodes="172.0.0.1:6379 172.0.0.2:6379"
