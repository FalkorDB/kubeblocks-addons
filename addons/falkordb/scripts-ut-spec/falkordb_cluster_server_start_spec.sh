...
Describe "FalkorDB Cluster Server Start Bash Script Tests"
  # load the scripts to be tested and dependencies
  Include $common_library_file
  Include ../falkordb-cluster-scripts/falkordb-cluster-common.sh
  Include ../falkordb-cluster-scripts/falkordb-cluster-server-start.sh
  ...
  Describe "get_current_comp_nodes_for_scale_out_replica()"
    Context "when cluster nodes info contains only one line"
      ...
      It "returns early when cluster nodes info contains only one line"
        export ALL_SHARDS_COMPONENT_SHORT_NAMES="falkordb-shard-sxj,falkordb-shard-abc,falkordb-shard-def"
        When call get_current_comp_nodes_for_scale_out_replica "falkordb-shard-sxj-0.falkordb-shard-sxj-headless.default.svc" "6379"
    ...
    Context "when using advertised ports"
      ...
      It "parses current component nodes correctly when using advertised ports"
        When call get_current_comp_nodes_for_scale_out_replica "falkordb-shard-sxj-0.falkordb-shard-sxj-headless.default.svc" "6379"
        The status should be success
        The variable current_comp_primary_node should equal "10.42.0.227#falkordb-shard-sxj-0.falkordb-shard-sxj-headless.default.svc#10.42.0.227:31000@32000"
        The variable current_comp_other_nodes should equal "10.42.0.228#falkordb-shard-sxj-1.falkordb-shard-sxj-headless.default.svc#10.42.0.228:31001@32001"
        The variable other_comp_primary_nodes should equal "10.42.0.229#falkordb-shard-abc-0.falkordb-shard-abc-headless.default.svc#10.42.0.229:32222@32223"
    ...
    Context "when not using advertised ports"
      ...
      It "parses current component nodes correctly when not using advertised ports"
        When call get_current_comp_nodes_for_scale_out_replica "falkordb-shard-sxj-0.falkordb-shard-sxj-headless.default.svc" "6379"
        The variable current_comp_primary_node should equal "10.42.0.227#falkordb-shard-sxj-0.falkordb-shard-sxj-headless.default.svc#falkordb-shard-sxj-0.falkordb-shard-sxj-headless.default.svc:6379@16379"
        The variable current_comp_other_nodes should equal "10.42.0.228#falkordb-shard-sxj-1.falkordb-shard-sxj-headless.default.svc#falkordb-shard-sxj-1.falkordb-shard-sxj-headless.default.svc:6379@16379"
        The variable other_comp_primary_nodes should equal "10.42.0.229#falkordb-shard-abc-0.falkordb-shard-abc-headless.default.svc#falkordb-shard-abc-0.falkordb-shard-abc-headless.default.svc:6379@16379"
        The stdout should include "other_comp_other_nodes: "
      End
    End
  End
  ...
  Describe "check_and_meet_other_primary_nodes()"
    ...
    Context "when send cluster meet command fails"
      ...
      setup() {
        other_comp_primary_nodes=("172.0.0.1#falkordb-shard-sxj-1.falkordb-shard-sxj-headless.default.svc#falkordb-shard-sxj-1.falkordb-shard-sxj-headless.default.svc:6379@16379")
        retry_times=1
        retry_delay_second=1
        export service_port="6379"
      }
  ...
  Describe "scale_redis_cluster_replica()"
    Context "when redis server is not ready"
      ...
      It "exits when redis server is not ready"
        ...
        The status should be failure
        The stderr should include "FalkorDB server is not ready, exit scale out replica..."
      End
    End
    ...
    Context "when current pod is already in the cluster"
      ...
      get_target_pod_fqdn_from_pod_fqdn_vars() {
        echo "falkordb-shard-sxj-0.falkordb-shard-sxj-headless.default.svc"
      }
      ...
      It "exits when current pod is already in the cluster"
        When run scale_redis_cluster_replica
        The status should be success
        The stdout should include "Node falkordb-shard-sxj-0 is already in the cluster, skipping scale out replica..."
      End
    End
    ...
    Context "when current pod is primary node"
      ...
      It "checks and corrects other primary nodes when current pod is primary node"
        When run scale_redis_cluster_replica
        The status should be success
        The stdout should include "Current pod falkordb-shard-sxj-0 is primary node, check and correct other primary nodes..."
      End
    End
    ...
    Context "when failed to get cluster id of primary node"
      ...
      It "exits with error when failed to get cluster id of primary node"
        When run scale_redis_cluster_replica
        The status should be failure
        The stdout should include "FalkorDB server is ready, continue to scale out replica"
        The stderr should include "Failed to get the cluster id of the primary node falkordb-shard-sxj-0.falkordb-shard-sxj-headless.default.svc:6379"
      End
    End
    ...
    Context "when failed to add current node as replica"
      ...
      It "exits with error when failed to add current node as replica"
        ...
        The status should be failure
        The stdout should include "FalkorDB server is ready, continue to scale out replica"
        The stderr should include "Failed to add the node falkordb-shard-sxj-0.falkordb-shard-sxj-headless.default.svc to the cluster in scale_redis_cluster_replica"
      End
    End
  ...
  Describe "scale_out_replica_send_meet()"
    Context "when node is already in cluster"
      ...
      It "returns success when node is already in cluster"
        When call scale_out_replica_send_meet "127.0.0.1" "6379" "16379" "falkordb-shard-sxj-1"
        The status should be success
