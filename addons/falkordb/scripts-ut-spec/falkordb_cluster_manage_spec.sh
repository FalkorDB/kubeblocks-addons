...
Describe "FalkorDB Cluster Manage Bash Script Tests"
  # load the scripts to be tested and dependencies
  Include $common_library_file
  Include ../falkordb-cluster-scripts/falkordb-cluster-common.sh
  Include ../falkordb-cluster-scripts/falkordb-cluster-manage.sh
  ...
  Describe "get_current_comp_nodes_for_scale_in()"
    Context "when cluster nodes info contains only one line"
      get_cluster_nodes_info() {
        cluster_nodes_info="4958e6dca033cd1b321922508553fab869a29d 10.42.0.227:6379@16379,falkordb-shard-sxj-0.falkordb-shard-sxj-headless.default.svc master - 0 1711958289570 4 connected 0-1364 5461-6826 10923-12287"
        echo "$cluster_nodes_info"
      }
      It "returns early when cluster nodes info contains only one line"
        When call get_current_comp_nodes_for_scale_in "falkordb-shard-sxj-0.falkordb-shard-sxj-headless.default.svc" "6379"
        The status should be success
    ...
    Context "when using advertised ports"
      get_cluster_nodes_info() {
        cluster_nodes_info="4958e6dca033cd1b321922508553fab869a29d 10.42.0.227:31000@32000,falkordb-shard-sxj-0.falkordb-shard-sxj-headless.default.svc master - 0 1711958289570 4 connected 0-1364 5461-6826 10923-12287"$'\n'"7381c6dca033cd1b321922508553fab869a29e 10.42.0.228:31001@32001,falkordb-shard-sxj-1.falkordb-shard-sxj-headless.default.svc slave 4958e6dca033cd1b321922508553fab869a29d 0 1711958289570 4 connected"
        echo "$cluster_nodes_info"
      }

      setup() {
        export CURRENT_SHARD_ADVERTISED_PORT="falkordb-shard-sxj-0:31000,falkordb-shard-sxj-1:31001"
        export CURRENT_SHARD_COMPONENT_NAME="falkordb-shard-sxj"
    ...
    Context "when not using advertised ports"
      get_cluster_nodes_info() {
        cluster_nodes_info="4958e6dca033cd1b321922508553fab869a29d 10.42.0.227:6379@16379,falkordb-shard-sxj-0.falkordb-shard-sxj-headless.default.svc master - 0 1711958289570 4 connected 0-1364 5461-6826 10923-12287"$'\n'"7381c6dca033cd1b321922508553fab869a29e 10.42.0.228:6379@16379,falkordb-shard-sxj-1.falkordb-shard-sxj-headless.default.svc slave 4958e6dca033cd1b321922508553fab869a29d 0 1711958289570 4 connected"
        echo "$cluster_nodes_info"
      }
      setup() {
        unset CURRENT_SHARD_ADVERTISED_PORT
      ...
      It "parses current component nodes correctly when not using advertised ports"
        When call get_current_comp_nodes_for_scale_in "falkordb-shard-sxj-0.falkordb-shard-sxj-headless.default.svc" "6379"
        The status should be success
        The variable current_comp_primary_node should equal "falkordb-shard-sxj-0.falkordb-shard-sxj-headless.default.svc:6379"
        The variable current_comp_other_nodes should equal "falkordb-shard-sxj-1.falkordb-shard-sxj-headless.default.svc:6379"
        The stdout should include "current_comp_primary_node: falkordb-shard-sxj-0.falkordb-shard-sxj-headless.default.svc:6379"
      End
    End
  ...
  Describe "init_current_comp_default_nodes_for_scale_out()"
    Context "when using advertised ports"
      min_lexicographical_order_pod() {
        echo "falkordb-shard-sxj-0"
      }

      parse_host_ip_from_built_in_envs() {
        case "$1" in
          "falkordb-shard-sxj-0")
            echo "10.42.0.1"
            ;;
          "falkordb-shard-sxj-1")
            echo "10.42.0.2"
            ;;
        esac
      }
    ...
    Context "when not using advertised ports"
      ...
      get_target_pod_fqdn_from_pod_fqdn_vars() {
        case "$1" in
          "falkordb-shard-sxj-0.falkordb-shard-sxj-headless.default.svc.cluster.local,falkordb-shard-sxj-1.falkordb-shard-sxj-headless.default.svc.cluster.local")
            case "$2" in
              "falkordb-shard-sxj-0")
                echo "falkordb-shard-sxj-0.falkordb-shard-sxj-headless.default.svc.cluster.local"
                ;;
              "falkordb-shard-sxj-1")
                echo "falkordb-shard-sxj-1.falkordb-shard-sxj-headless.default.svc.cluster.local"
                ;;
            esac
            ;;
        esac
    ...
    Context "when failed to get ordinal of min lexicographical pod"
      ...
      It "exits with error when failed to get ordinal of min lexicographical pod"
        ...
        The status should be failure
        The stderr should include "Failed to get the ordinal of the min lexicographical pod falkordb-shard-sxj-0 in init_current_comp_default_nodes_for_scale_out"
      End
    End
    ...
    Context "when failed to get host ip of pod"
      ...
      It "exits with error when failed to get host ip of pod"
        When run init_current_comp_default_nodes_for_scale_out
        The status should be failure
        The stderr should include "Failed to get host ip of pod falkordb-shard-sxj-0"
      End
    End
    ...
    Context "when advertised port not found for pod"
      ...
      It "exits with error when advertised port not found for pod"
        When run init_current_comp_default_nodes_for_scale_out
        The status should be failure
        The stderr should include "Advertised port not found for pod falkordb-shard-sxj-1"
      End
    End
  ...
  Describe "gen_initialize_redis_cluster_node()"
    ...
    Context "when failed to get ordinal of min lexicographical pod"
      ...
      It "returns error when failed to get ordinal of min lexicographical pod"
        When call gen_initialize_redis_cluster_node "true"
        The status should be failure
        The error should include "Failed to get the ordinal of the min lexicographical pod falkordb-shard-7hy-0 in gen_initialize_redis_cluster_node"
      End
    End
...
d-98x-redis-advertised-1:31318.shard-7hy@falkordb-shard-7hy-redis-advertised-0:32025,falkordb-shard-7hy-redis-advertised-1:31319.shard-jwl@falkordb-shard-jwl-redis-advertised-0:32026,falkordb-shard-jwl-redis-advertised-1:31320"
      ...
      It "exits with error when failed to get host ip of pod"
        ...
        The status should be failure
        The stderr should include "Failed to get host IP for pod: falkordb-shard-98x-0"
      End
    End
  ...
  Describe "initialize_redis_cluster()"
    ...
    Context "when failed to initialize the secondary node"
      ...
      It "exits with error when failed to initialize the secondary node"
        When run initialize_redis_cluster
        The status should be failure
        The stderr should include "Failed to initialize the secondary node falkordb-shard-98x-1, secondary replicated output:"
  ...
  Describe "scale_out_redis_cluster_shard()"
    ...
    Context "when failed to initialize the default primary and secondary nodes for scale out"
      ...
      It "returns error when failed to initialize the default primary and secondary nodes for scale out"
        ...
        The stdout should include "skip the pod falkordb-shard-98x-1 as it belongs the component shard-98x"
      End
    End
    ...
    Context "when failed to generate primary nodes when scaling out"
      ...
      It "returns error when failed to generate primary nodes when scaling out"
        ...
        The stdout should include "FalkorDB cluster scale out shard default primary and secondary nodes successfully"
      End
    End
    ...
    Context "when failed to scale out shard primary node"
      ...
      It "returns error when failed to scale out shard primary node"
        When call scale_out_redis_cluster_shard
        The status should be failure
        The error should include "Failed to scale out shard primary node falkordb-shard-98x-0"
        The stdout should include "FalkorDB cluster scale out shard default primary and secondary nodes successfully"
      End
    End
    ...
    Context "when failed to scale out shard reshard"
      ...
      It "returns error when failed to scale out shard reshard"
        ...
        The stdout should include "FalkorDB cluster scale out shard secondary node falkordb-shard-98x-1 successfully"
      End
    End
  End
  ...
  Describe "scale_in_redis_cluster_shard()"
    ...
    Context "when the number of shards in the cluster is less than 3 after scaling down"
      find_exist_available_node() {
        echo "falkordb-shard-98x-0.namespace.svc.cluster.local:6379"
      }
      ...
      It "returns 1 when the number of shards in the cluster is less than 3 after scaling down"
        ...
        The stdout should include "other_undeleted_component_nodes: falkordb-shard-7hy-0.falkordb-shard-7hy-headless.kb-system.svc.cluster.local:6379 falkordb-shard-7hy-1.falkordb-shard-7hy-headless.kb-system.svc.cluster.local:6379 falkordb-shard-jwl-0.falkordb-shard-jwl-headless.kb-system.svc.cluster.local:6379"
      End
    End
    ...
    Context "when failed to rebalance the cluster for the current component when scaling in"
      ...
      It "returns 1 when failed to rebalance the cluster for the current component when scaling in"
        ...
        The stdout should include "other_undeleted_component_nodes: falkordb-shard-7hy-0.falkordb-shard-7hy-headless.kb-system.svc.cluster.local:6379 falkordb-shard-7hy-1.falkordb-shard-7hy-headless.kb-system.svc.cluster.local:6379 falkordb-shard-jwl-0.falkordb-shard-jwl-headless.kb-system.svc.cluster.local:6379 falkordb-shard-jwl-1.falkordb-shard-jwl-headless.kb-system.svc.cluster.local:6379 falkordb-shard-kpl-0.falkordb-shard-kpl-headless.kb-system.svc.cluster.local:6379 falkordb-shard-kpl-1.falkordb-shard-kpl-headless.kb-system.svc.cluster.local:6379"
      End
    End
    ...
    Context "when failed to delete the node from the cluster when scaling in"
      ...
      It "returns 1 when failed to delete the node from the cluster when scaling in"
        When call scale_in_redis_cluster_shard
        The status should be failure
        The error should include "Failed to delete the node falkordb-shard-98x-0.namespace.svc.cluster.local:6379 from the cluster when scaling in"
        The stdout should include "FalkorDB cluster scale in shard rebalance to zero successfully"
      End
    End
  End
  ...
  Describe "initialize_or_scale_out_redis_cluster()"
    ...
    Context "when FalkorDB Cluster is not initialized"
      ...
      It "initializes FalkorDB Cluster successfully"
        When run initialize_or_scale_out_redis_cluster
        The status should be success
        The output should include "FalkorDB Cluster not initialized, initializing..."
        The output should include "FalkorDB Cluster initialized successfully"
      End
    End
    ...
    Context "when FalkorDB Cluster is already initialized"
      ...
      It "scales out FalkorDB Cluster shard successfully"
        When run initialize_or_scale_out_redis_cluster
        The status should be success
        The output should include "FalkorDB Cluster already initialized, scaling out the shard..."
        The output should include "FalkorDB Cluster scale out shard successfully"
      End
    End

    Context "when failed to initialize FalkorDB Cluster"
      check_cluster_initialized() {
        return 1
      }
      ...
      It "exits with status 1 when failed to initialize FalkorDB Cluster"
        When run initialize_or_scale_out_redis_cluster
        The status should be failure
    ...
    Context "when failed to scale out FalkorDB Cluster shard"
      check_cluster_initialized() {
        return 0
      }
      ...
      It "exits with status 1 when failed to scale out FalkorDB Cluster shard"
        When run initialize_or_scale_out_redis_cluster
        The status should be failure
